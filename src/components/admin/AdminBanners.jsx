        ...
        <div className="d-flex flex-column mb-4" ref={dropRef} tabIndex="0" style={{ outline: 'none' }}>
            ...
            <div
                ...
                style={{
                    ...
                    borderColor: isDragging ? '#d63384' : '#dee2e6',
            ...
            >
                ...
                {subiendo ? (
                    <div className="text-pink"><div className="spinner-border spinner-border-sm mb-2"></div><p className="small mb-0 fw-bold">Subiendo...</p></div>
                ) : image ? (
                    ...
                    <div className="text-muted p-4">
                        <i className="bi bi-cloud-arrow-up fs-1 opacity-25 mb-2"></i>
...
export default function AdminBanners() {
    ...
    const handleDragEnd = async (resultBanners) => {
        ...
        // Actualizar el orden en Supabase para cada elemento
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (!formData.image_url) return alert("Por favor sube una imagen primero");
        ...
        <div className="container py-4">
            ...
            <div className="row g-4">
                <div className="col-lg-8">
                    <div className={`card shadow-sm border-0 p-4 h-100 ${styles.contenedor}`}>
                        <h5 className="mb-4 fw-bold">{idEdicion ? 'Editar Banner' : 'Crear Nuevo Banner'}</h5>
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="row g-3">
                                ...
                                <div className="col-md-5">
                                    <label className="small fw-bold text-secondary mb-1">Enlace (opcional)</label>
                                ...
                                <div className="col-12 d-flex justify-content-between align-items-center mt-3">
                                    ...
                                    <div className="d-flex gap-2">
                                        {idEdicion && (
                                            <button type="button" className="btn btn-light border fw-bold px-4" onClick={() => { setIdEdicion(null); setFormData({ title: '', link: '', active: true, order: 0, image_url: '', image_position: 50 }); }}>
                                                Cancelar
                                            </button>
                                        )}
                                        ...
                                        <div className="p-3">
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="overflow-hidden me-2" style={{ cursor: 'default' }}>
                                                    <h6 className="mb-0 small fw-bold text-truncate">{b.title || 'Sin título'}</h6>
                                                    <span className="extra-small text-muted">Posición: {index + 1}</span>
                                                </div>

                                                {/* ACCIONES - Con stopPropagation para que no interfiera el Drag */}
                                                <div className="d-flex gap-1" onMouseDown={(e) => e.stopPropagation()}>
                                                    <button
                                                        type="button"
                                                        onClick={(e) => { e.stopPropagation(); toggleVisibility(b.id, b.active); }}
                                                        className={`btn btn-sm p-1 border-0 ${b.active ? 'text-success' : 'text-secondary'}`}
                                                        title="Visibilidad"
                                                    >
                                                        <i className={`bi ${b.active ? 'bi-eye-fill' : 'bi-eye-slash-fill'}`} style={{ fontSize: '1.1rem' }}></i>
                                                    </button>
